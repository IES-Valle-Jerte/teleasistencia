...
public class RelacionPacientePersonaAdapter extends RecyclerView.Adapter<RelacionPacientePersonaAdapter.PacienteViewHolder> {
    ...
    public RelacionPacientePersonaAdapter(List<Paciente> items) {
        this.items = items;
    }
